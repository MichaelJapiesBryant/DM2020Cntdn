   ...
   if(Final_Result > 0)  //Start of the  caltulation for the date. Syntax for the message can be changed here. 
{
	...
	status += 'There are ' + Final_Result +  ' days left until the release of #DOOM #DOOMEternal AND #AnimalCrossing #NewHorizons';
}
else
{
 //Final status
    status += 'Doom Eternal and Animal Crossing: New Horizons Releases today!';
}
